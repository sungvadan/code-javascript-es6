...
(function (window, $, Routing, swal) {
    var RepLogApp = function () {
        ...
        _createClass(RepLogApp, [{
            ...
            value: function _addRow(repLog) {
                // let { id, itemLabel, reps = "already exists", totallyMAdeup = "what ever" } = repLog;
                // console.log(id, itemLabel, reps, totallyMAdeup);
    ...
    var Helper = function () {
        ...
        _createClass(Helper, [{
            ...
            value: function _calculateWeight($elements) {
                var totalWeight = 0;
                $elements.find('tbody tr').each(function (index, element) {
